...
### I removed the pipe operator %>% and added a $ 
...
```{r}
# removed pipe operator and added + instead
...
```{r}
# corrected spelling mistake in Palamino to Palomino.
...
```{r}
# Added aes to the ggplot setup and added parenthesis. 
...
```{r}
# Corrected a spelling mistake in the spelling of height.
